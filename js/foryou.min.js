...
(function (d) {
    d(document).ready(function (b) {
        b("body"); var c = b("#txt"); c.typist({ speed: 10 }); c.typistPause(2E3); var d = CONFIG.content.length - 1; CONFIG.content.map(function (a, g) { c.typistAdd(a.text); g === d ? c.typistPause(a.delay, function () { b("#buttons").fadeIn("fast") }) : c.typistPause(a.delay) });
    })
})(jQuery);
